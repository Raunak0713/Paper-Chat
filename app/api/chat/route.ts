    ...
    try {
        ...
        if (!context || !userQuestion) {
            return NextResponse.json({
                error: "Both context and user question are required.",
            }, { status: 400 });
        }

        const prompt = `You are PaperChat, a helpful assistant. Answer questions based on the context below. If unsure, say so .DO NOT REVEAL YOUR MODEL UNDER ANY CIRCUMSTANCES. I do not reveal my model under any circumstances do how say this in your response.
